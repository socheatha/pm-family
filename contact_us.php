<?php 
	...
	if (isset($_POST['btn_send_mail'])) 
	{
		...
		$v_message = "-name: " .$v_name. "\r\n-tel: " . $v_phone . "\r\n-email: " .$v_email. "\r\n-message: " . $v_message;
		$headers = "From: ".$v_email;

		if(mail($to,$subject,$v_message,$headers)){
			echo '<script> window.alert("'.$lang_text['ct_email_sended'][$lang].'"); window.location.replace("'.$_SERVER['SCRIPT_NAME'].'"); </script>';
		}else{
			...
			<div class="form-contact">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-6">
						<span class="wpcf7-form-control-wrap your-name"><input type="text" required name="txt_name" value="" size="40" class="form-control" aria-required="true" aria-invalid="false" placeholder="<?= $lang_text['ct_name'][$lang]  ?>"></span>
					</div>
					<div class="col-xs-12 col-sm-6">
						<span class="wpcf7-form-control-wrap your-email"><input type="email" required name="txt_email" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-email form-control" id="Email" aria-invalid="false" placeholder="<?= $lang_text['ct_email'][$lang]  ?>"></span>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-12 col-sm-6">
						<span class="wpcf7-form-control-wrap tel-72"><input type="tel" required name="txt_phone" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel form-control" aria-required="true" aria-invalid="false" placeholder="<?= $lang_text['ct_phone'][$lang]  ?>"></span>
					</div>
					<div class="col-xs-12 col-sm-6">
						<span class="wpcf7-form-control-wrap your-subject"><input type="text" required name="txt_subject" value="" size="40" class="wpcf7-form-control wpcf7-text form-control" id="contact-subject" aria-invalid="false" placeholder="<?= $lang_text['ct_subject'][$lang]  ?>"></span>
					</div>
				</div>
				<p><span class="wpcf7-form-control-wrap your-message"><textarea name="txt_message" required cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea form-control" aria-invalid="false" placeholder="<?= $lang_text['ct_message'][$lang]  ?>"></textarea></span></p>
				...
				<p><input type="submit" name="btn_send_mail" value="<?= $lang_text['ct_sent_button'][$lang]  ?>" class="wpcf7-submit btn btn-submit btn-submit-kh"><span class="ajax-loader"></span></p>
			</div>
		</form>
		<br>
	</div>
