...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-cubes fa-fw"></i> Project Feature Administrator</h2>
        </div>
    </div>
    <br>
    <br>
        ...
        <div id="sample_1_wrapper" class="dataTables_wrapper">
            <table class="table table-striped table-bordered table-hover dataTable dtr-inline" id="sample_2" role="grid" aria-describedby="sample_1_info">
                ...
                <tbody>                                 
                    <?php 
                        $i = 0;
                        $get_data = $connect->query("SELECT * FROM tbl_project_feature ORDER BY name_en ASC");
                        while ($row = mysqli_fetch_object($get_data)) {
                            echo '<tr>';
                                ...
                                echo '<td class="text-center">
                                    <a href="../../img/project/feature/'.$row->profile.'" target="_blank"><img src="../../img/project/feature/'.$row->profile.'" height="50px"/></a>
                                </td>';
                                echo '<td>'.$row->note.'</td>';
