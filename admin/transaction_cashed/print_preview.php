...
<body onload="window.print();">
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-5"><h4 style="font-family: 'khmer moul'; font-weight: bold;"><?= $lang_text['invoice'][$lang] ?><br><?= $lang_text['date'][$lang] ?></h4></div>
			<div class="col-xs-7 text-right">
				<h4 style="font-family: 'time new roman'; font-weight: bold;">N<sup>o</sup> : <?= sprintf('%08d',$row['t_id']) ?><br><?= $row['t_date_cashed'] ?></h4>
			</div>
		</div><br>
		<table width="100%">
			<tr>
		...
		<div class="row">
			...
			<div class="col-xs-6 text-right"><strong><?= $lang_text['finishedDate'][$lang] ?>:</strong><br> <?= $row['t_date_finished']?></div>
		</div><br>
		<div class="row">
			<div class="col-xs-6">
				<strong><?= $lang_text['receivedBy'][$lang] ?>:</strong><br><?= $row['username']?>
			</div>
			<div class="col-xs-6 text-right">
				<strong><?= $lang_text['fixByEmployee'][$lang] ?>:</strong><br><?= $row['name_english']?>
			</div>
		</div>
		<br>
