  ...
  if(isset($_POST['search'])){
    ...
    if($_POST['txt_option'] != ""){
      ...
      $sql = "SELECT * FROM tbl_pos_stockout A 
              ...
              WHERE A.date_out >= '$dateStart' AND A.date_out <='$dateEnd' AND A.so_user_id='$cus_id_s'";  
      ...
      $sql = "SELECT * FROM tbl_pos_stockout A 
              ...
              LEFT JOIN tbl_pos_category C ON B.cate_id=C.cate_id
              LEFT JOIN tbl_pos_user AS U ON U.id=A.so_user_id
              WHERE A.date_out >= '$dateStart' AND A.date_out <='$dateEnd'";  
      $result = $connect->query($sql);
    }            
  }else{
    $v_date = date('Y-m-d');
...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-image fa-fw"></i> Report Sell by Employee </h2>
        </div>
    </div>
    <br>
    <br>
