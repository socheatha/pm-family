...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $query_update = "UPDATE `tbl_account_expense` 
            SET 
                ae_date='$v_date',
                ae_category='$v_cate',
                ae_title='$v_title',
                ae_amount_dollar='$v_amn_usd',
                ae_amount_riel='$v_amn_khr',
                ae_note='$v_note'
            WHERE `ae_id`='$v_id'";
...
// get old data 
    ...
    $old_data = $connect->query("SELECT * FROM tbl_account_expense WHERE ae_id='$edit_id'");
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="#" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="txt_id" value="<?= $row_old_data->ae_id ?>">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label><?= $lang_text['date'][$lang] ?> : </label>
                                    <input type="text" class="form-control" name="txt_date_record" required=""  autocomplete="off" value="<?= $row_old_data->ae_date ?>" data-provide="datepicker" data-date-format="yyyy-mm-dd">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select  class="form-control selectpicker" name="txt_category" required="" data-live-search="true">
                                        ...
                                        <?php 
                                            ...
                                            while ($row_data = mysqli_fetch_object($select_data)) {
                                                if($row_data->ac_id == $row_old_data->ae_category)
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="txt_title" required=""  autocomplete="off" value="<?= $row_old_data->ae_title ?>">
                                </div>
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            <label><?= $lang_text['amountUsd'][$lang] ?> : </label>
                                            <input type="number" step="any" class="form-control" name="txt_amount_usd" required=""  autocomplete="off" value="<?= $row_old_data->ae_amount_dollar ?>">
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            <label><?= $lang_text['amountRiel'][$lang] ?> : </label>
                                            <input type="number" class="form-control" name="txt_amount_khr" required=""  autocomplete="off" value="<?= $row_old_data->ae_amount_riel ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" name="txt_note" style="height: 254px;" autocomplete="off"><?= $row_old_data->ae_note ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
