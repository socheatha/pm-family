...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-fw fa-map-marker"></i> <?= $lang_text['reportIncomeDetail'][$lang] ?></h2>
        </div>
    </div>    
    <br>
    <br>
                    ...
                    <?php
                        if(isset($_GET['btn_search'])){
                            ...
                            $get_data = $connect->query("SELECT 
                                ...
                                WHERE DATE_FORMAT(A.ai_date,'%Y-%m-%d') BETWEEN '$v_date_s' AND '$v_date_e'
                        ...
                        while ($row = mysqli_fetch_object($get_data)) {
                            $sum_amount_usd += $row->ai_amount_dollar;
                            $sum_amount_khr += $row->ai_amount_riel;
                            echo '<tr>';
                                echo '<td>'.(++$i).'</td>';
