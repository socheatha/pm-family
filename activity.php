							...
							<div class="row list-inner">
								<div class="col-sm-5 image custom-img">
									<figure class="entry-thumb effect-v6">
										<a class="post-thumbnail" href="activity_detail.php?id='.$row->id.'" aria-hidden="true">
										...
										<div class="col-sm-7 info">
											...
											<h4 class="entry-title"> <a href="activity_detail.php?id='.$row->id.'">'.$row->{'title_'.$lang}.'</a> </h4>
											<div class="date">
